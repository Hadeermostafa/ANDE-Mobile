...
class _InternationalPhoneInputState extends State<InternationalPhoneInput> {
  ...
  void initState() {
    ...
    showCountryFlags = widget.showCountryFlags ?? true;
    ...
    List<Country> countries = List<Country>.generate(jsonList.length, (index) {
      ...
      if (widget.enabledCountries.isEmpty) {
        return Country(
            ...
            flagUri: 'assets/images/flags/${elem['alpha_2_code'].toLowerCase()}.png');
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Row(
        ...
        children: <Widget>[
          AbsorbPointer(
            absorbing: widget.enabledCountries.length == 1,
            child: Container(
                  ...
                  child: DropdownButton<Country>(
                    ...
                    icon: Padding(
                      padding: EdgeInsets.only(
                          bottom: (decoration != null) ? 6 : 0),
                      child: widget.enabledCountries.length == 1
                          ? Container(
                        width: 24,
                      )
