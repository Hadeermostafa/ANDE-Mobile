...
class AndeBottomNavigationBar extends StatefulWidget {
  AndeBottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
...
class _BottomNavigationBarState extends State<AndeBottomNavigationBar>
  ...
  @override
  void didUpdateWidget(AndeBottomNavigationBar oldWidget) {
